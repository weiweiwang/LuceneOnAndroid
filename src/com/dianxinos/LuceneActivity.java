...
public class LuceneActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Button t1 = (Button) this.findViewById(R.id.button1);
		// Button t2 = (Button) this.findViewById(R.id.button2);
		// Button t3 = (Button) this.findViewById(R.id.button3);
		// Button t4 = (Button) this.findViewById(R.id.button4);
		// Button t5 = (Button) this.findViewById(R.id.button5);
		// Button t6 = (Button) this.findViewById(R.id.button6);
		// Button t7 = (Button) this.findViewById(R.id.button7);
		// Button t8 = (Button) this.findViewById(R.id.button8);
		// Button t9 = (Button) this.findViewById(R.id.button9);
		// Button t10 = (Button) this.findViewById(R.id.button10);
		// Button t11 = (Button) this.findViewById(R.id.button11);
		// Button t12 = (Button) this.findViewById(R.id.button12);
		...
		try {
			...
			try {
			   textView.append("\nnumDocs:" + indexWriter.numDocs() + "\n");
				docs = new ArrayList<Map<String, Object>>(5);
	...
	public void setT9Value(View view) {
		...
		case R.id.button1: {
			...
			if(docs!=null&&!docs.isEmpty()){
				textView.append(  "docs:" + docs.toString() + "\n");
				docs.clear();
			}
			break;
		}
